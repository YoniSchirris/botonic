...
export class BotonicDecorator {
  addDecorator(type: MessageType, decorator: (node: React.Component, key: string|undefined) => React.ReactNode)

  decorate(type: MessageType, node: React.Component): React.ReactNode
}
